...
function Scatterplot(data, {
    ...
    // Add fixed values in data for fixed scaling
    // const left = { 'min_position_x': '150', 'min_position_y': '250', 'first_name': 'Placeholder' }
    // const right = { 'min_position_x': '350', 'min_position_y': '250', 'first_name': 'Placeholder' }
    // const top = { 'min_position_x': '250', 'min_position_y': '350', 'first_name': 'Placeholder' }
    // const bottom = { 'min_position_x': '250', 'min_position_y': '150', 'first_name': 'Placeholder' }
    // data.push(left)
    // data.push(right)
    // data.push(top)
    // data.push(bottom)
